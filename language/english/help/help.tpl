<div id="help-template" class="outer">
    <{include file=$smarty.const._MI_SPOT_HELP_HEADER}>

    <h4 class="odd">DESCRIPTION</h4> <br>
    <br>
    <p>This module puts a News item in a central spotlight block. It has the following features:<br> <br>

    <ul>
        <li> Create a block displaying the intro text of a given news article</li>
        <li> Add a custom image to the spotlighted article block</li>
        <li> Control look and feel through block template</li>
        <li> Display other recent news below spotlighted item</li>
        <li> Admin lenth ot titles through block admin</li>
        <li> Admin order and number of other recent news items displayed.</li>
    </ul>
    <br>
    </p>
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/mambax7/spotlight" target="_blank">GitHub</a><br><br>
